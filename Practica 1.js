...
const returnMovieTitle = watchList.filter(
  (movies) => movies.imdbRating >= 8 && movies.Director === "Christopher Nolan"
);
...
const titlesArray = returnMovieTitle.map((watchList) => watchList.Title);
